...
import pytest
from source_robin.source import RobinStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(RobinStream, "path", "v0/example_endpoint")
    mocker.patch.object(RobinStream, "primary_key", "test_primary_key")
    mocker.patch.object(RobinStream, "__abstractmethods__", set())
