...
import pytest
from source_palo_alto.source import PaloAltoStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(PaloAltoStream, "path", "v0/example_endpoint")
    mocker.patch.object(PaloAltoStream, "primary_key", "test_primary_key")
    mocker.patch.object(PaloAltoStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = PaloAltoStream()
