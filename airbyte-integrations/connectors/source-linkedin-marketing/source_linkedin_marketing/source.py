...
class Customers(LinkedinMarketingStream):
    """
...
class IncrementalLinkedinMarketingStream(LinkedinMarketingStream, ABC):
    """
...
class Employees(IncrementalLinkedinMarketingStream):
    """
    TODO: Change class name to match the table/data source this stream corresponds to.
    """
