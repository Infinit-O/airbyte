...
import pytest
from source_zscaler.source import ZscalerStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(ZscalerStream, "path", "v0/example_endpoint")
    mocker.patch.object(ZscalerStream, "primary_key", "test_primary_key")
    mocker.patch.object(ZscalerStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = ZscalerStream()
