...
import pytest
from source_phished_io.source import PhishedIoStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(PhishedIoStream, "path", "v0/example_endpoint")
    mocker.patch.object(PhishedIoStream, "primary_key", "test_primary_key")
    mocker.patch.object(PhishedIoStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = PhishedIoStream()
