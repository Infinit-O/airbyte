...
import pytest
from source_jumpcloud.source import JumpcloudStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(JumpcloudStream, "path", "v0/example_endpoint")
    mocker.patch.object(JumpcloudStream, "primary_key", "test_primary_key")
    mocker.patch.object(JumpcloudStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = JumpcloudStream()
