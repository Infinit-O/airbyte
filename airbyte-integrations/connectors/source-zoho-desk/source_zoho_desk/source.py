...
class CommunityTopicTypes(ZohoDeskStream):
    primary_key = "id"
...
class CommunityPreferences(ZohoDeskStream):
    primary_key = "id"
...
class AvailableBadgeIcons(ZohoDeskStream):
    primary_key = "id"
