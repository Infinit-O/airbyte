...
import pytest
from source_zoho_desk.source import ZohoDeskStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(ZohoDeskStream, "path", "v0/example_endpoint")
    mocker.patch.object(ZohoDeskStream, "primary_key", "test_primary_key")
    mocker.patch.object(ZohoDeskStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = ZohoDeskStream()
