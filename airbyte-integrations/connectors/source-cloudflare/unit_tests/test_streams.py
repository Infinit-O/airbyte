...
import pytest
from source_cloudflare.source import CloudflareStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(CloudflareStream, "path", "v0/example_endpoint")
    mocker.patch.object(CloudflareStream, "primary_key", "test_primary_key")
    mocker.patch.object(CloudflareStream, "__abstractmethods__", set())
