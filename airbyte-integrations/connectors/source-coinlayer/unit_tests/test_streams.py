...
import pytest
from source_coinlayer.source import CoinlayerStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(CoinlayerStream, "path", "v0/example_endpoint")
    mocker.patch.object(CoinlayerStream, "primary_key", "test_primary_key")
    mocker.patch.object(CoinlayerStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = CoinlayerStream()
